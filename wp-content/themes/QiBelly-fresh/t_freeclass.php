...
<form action="http://www.bettermail.ca/bm/form.php" method="post">
...
<input id="param_nametext" type="text" name="fname" value="" maxlength="35"  data-validation='{"required":true, "message":"Please enter your name"}' placeholder="Name" size="20"  /></li>
	<li><label for="param_emailtext">Email Address</label>
<input id="param_emailtext" type="email" name="email" value="" maxlength="35"  data-validation='{"required":true, "message":"Please enter your email address"}' placeholder="xxxxx@xxxx.xxx" size="20" />
    </li>
	<li><label for="param_interest">Choose</label> <select id="param_interest" name="interest[]" data-validation='{"required":true}' > <option value="16592">General Contact</option> <option value="16593">Free Reiki Share</option> <option value="16595">Free QiGong / Tai Chi class</option> </select></li>
	<li><label for="param_comments">Comments</label>
<textarea name="comments"></textarea></li>
	<li><button id="submitbutton" value="" type="submit"></button>Sign me up!</li>
</ol>
</fieldset>
